...
$string['anonymous'] = 'Hide student names from trainer';
$string['anonymous_description'] = 'There are already quiz attempts and this quiz is set to hide student names and times of attempts from trainers. This setting cannot be changed.';
$string['anonymous_help'] = 'If selected, student names and times of attempts are hidden from the trainer in reports.';
